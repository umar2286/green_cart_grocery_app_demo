...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const GetMaterialApp(
      home: VendorBottomNavScreen(),
    );
  }
}

class VendorBottomNavScreen extends StatelessWidget {
    ...
    return Scaffold(
      body: Center(
        child: ElevatedButton(
          ...
          child: const Text('Go to Vendor Profile'),
        ),
      ),
    );
  }
          ...
          child: Column(
            ...
            children: [
              ...
              FutureBuilder<String?>(
                future: VendorStoreData().getVendorProfileImageURL(),
...
class _ProfileSettingState extends State<ProfileSetting>
  ...
  Future<void> selectVendorImage() async {
  ...
  void saveVendorProfile() async {
    Get.back();
    await VendorStoreData().saveVendorData(file: _image!);
    if (mounted) {
      setState(() {
...
class UserInfo {
  ...
  UserInfo(this.name, this.phoneNumber, this.address);
}
  ...
  Stream<List<UserInfo>> getUserInfoStream() {
    return FirebaseFirestore.instance.collection('User Info').snapshots().map(
          (snapshot) => snapshot.docs.map((doc) {
            ...
            return UserInfo(
                userData['name'], userData['phone'], userData['address']);
          }).toList(),
        );
  }
}
